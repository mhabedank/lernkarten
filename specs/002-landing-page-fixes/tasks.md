...
- [X] T039 Repeat T036 in the three engines the spike covered — Chromium, Firefox and Safari. *(Chromium measured headless, Safari checked by hand and positive. Firefox waived by the maintainer and left unverified — see research.md R2.)* CI has no browser leg and will not grow one for this feature, so this is the only place the cross-browser claim is checked
