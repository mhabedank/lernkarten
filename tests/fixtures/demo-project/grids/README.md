...
|---|---|---|
| `tides-a8.yaml` | `a8` | 12 cards — 2 pages at A8, 4 at A7, so a page count tells the two grids apart. Its short labels are now incidental: since BUG-007 the card scales, so the label budget is the same at both grids. |
